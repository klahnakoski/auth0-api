...
from pyLibrary.env.flask_session.sessions import SqliteSessionInterface
...
class Session(object):
    ...
    def _get_interface(self, app):
        ...
        config.setdefault("SESSION_SQLITE", None)
        config.setdefault("SESSION_SQLITE_TABLE", "sessions")

        session_interface = SqliteSessionInterface(
            app,
            config["SESSION_SQLITE"],
            config["SESSION_SQLITE_TABLE"],
